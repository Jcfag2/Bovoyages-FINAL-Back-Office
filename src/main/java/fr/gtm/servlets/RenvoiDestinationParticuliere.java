...
@WebServlet("/RenvoiDestinationParticuliere")
public class RenvoiDestinationParticuliere extends HttpServlet {
    ...
    public RenvoiDestinationParticuliere() {}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Destination destination = service.getDestinationById(Long.valueOf(id));
