...
<h2>Gestion de la destination ${destination.region}</h2>
      ...
      <input name="region" id="region" value="${ destination.region }">
      <input name="description" id="description" value="${ destination.description }">
      <button class="btn outline-dark" type="submit">modifier</button>
      </form>
      </td>
      <td>
      ...
      <input type="file" name="simple-file">
      <input type="hidden" name="id" id="id" value="${ destination.id }">
      <input class="btn outline-dark" type="submit" value="Ajouter Image" />
      </form>
      </div>
      <div id="presentation">
